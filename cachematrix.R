...
## It checks if the inverse of it is computed and cached before re-calculating the inverse
...
## This function returns the inverse of the matrix once created above. If avaialble it retrieves the matrix inverse
